...
> **Démarrage** : affiche immédiatement `[TPK-commit] 🤖 Modèle : sonnet` comme première ligne de sortie.
...
```
/TPK-commit "feat: add user authentication"
```

**With type prefix:**
```
/TPK-commit "fix: resolve login validation error"
```
